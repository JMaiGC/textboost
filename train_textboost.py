...
from training.dataset import InstructPix2PixDataset, TextBoostDataset, PriorDataset, Wrapper
from training.utils import (add_augmentation_tokens, add_token, encode_prompt,
...
def main(args):
    ...
    if args.augment in ("pda", "paug"):
        from training.augment import PairedAugmentation
        ...
        from training.augment import CustomDiffAugment
